...
2. [Обновление прошивки контроллера через командную оболочку](#Обновление-прошивки-контроллера-через-комндную-оболочку)
...
## Активация  и деактивации входа по SSH в качестве пользователя root:
